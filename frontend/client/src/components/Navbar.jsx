          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              ...
              <div className="flex space-x-4 items-center">
                ...
                <Link to="/register" className="btn-primary relative overflow-hidden group">
                  <span className="relative z-10">Book Now</span>
                  <motion.div
                    className="absolute inset-0 bg-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    style={{ mixBlendMode: 'overlay' }}
                  />
                  <div className="absolute inset-0 shadow-[0_0_20px_rgba(220,38,38,0)] group-hover:shadow-[0_0_25px_rgba(220,38,38,0.8)] transition-shadow duration-300 rounded-lg"></div>
                </Link>
              </div>
            )}
          </div>
