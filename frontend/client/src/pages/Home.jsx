  ...
  return (
    <div className="w-full bg-primary-950 text-white font-sans">
      ...
      <div className="relative pt-20 pb-32 lg:pt-32 lg:pb-40 overflow-hidden">
        <div className="absolute top-0 right-0 w-3/4 h-full bg-[url('https://images.unsplash.com/photo-1555215695-3004980ad54e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-60 mix-blend-screen" style={{ maskImage: 'linear-gradient(to right, transparent, black 30%)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 30%)' }}></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl">
            ...
            {/* Search Box */}
            <div className="glass p-6 rounded-2xl shadow-2xl max-w-sm mb-12">
              ...
              <div className="space-y-4">
                ...
                <Link to="/listings" className="w-full btn-primary py-4 mt-2 flex justify-center items-center rounded-xl text-lg font-bold">
                  Search Cars <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex justify-between items-end mb-8">
          ...
          <Link to="/listings" className="flex items-center text-sm font-medium text-white hover:text-accent transition-colors">
            View all cars <div className="ml-2 bg-accent rounded-full p-1 text-primary-950"><ArrowRight className="w-4 h-4"/></div>
          </Link>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {featuredCars.map((car) => (
            <div key={car._id} className="card p-4 group bg-primary-900 border-primary-800 hover:border-accent transition-colors">
              <div className="relative aspect-[16/10] overflow-hidden rounded-lg mb-4 bg-primary-950">
                <img src={car.images?.[0] || 'https://images.unsplash.com/photo-1617788138017-80ad40651399?auto=format&fit=crop&w=800&q=80'} alt={car.model} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 glass p-6 rounded-2xl z-20 max-w-xs shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mb-20">
        <div className="bg-gradient-to-r from-primary-900 to-[#104d44] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between border border-primary-800 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center mb-6 md:mb-0">
            <div className="w-16 h-16 rounded-2xl bg-accent/20 flex items-center justify-center md:mr-6 mb-4 md:mb-0 border border-accent/30 shrink-0 transform rotate-3">
          ...
          <Link to="/register" className="relative z-10 btn-primary py-4 px-8 rounded-full whitespace-nowrap flex items-center hover:scale-105 transition-transform">
